      ...
      <input {...getInputProps()} />
      {
        isDragActive ? (
          ...
          <>
            ...
            <Text textAlign="center" fontSize="2xl">ドラック & ドロップで<br />ファイルをアップロード</Text>
            <Text fontSize="2xl">or</Text>
            <Text textAlign="center" fontSize="2xl">クリックしてアップロードする<br />ファイルを選択</Text>
            <Text fontSize="2xl">or</Text>
            <Text textAlign="center" fontSize="2xl" mb="12">サンプルファイルを利用</Text>
          </>
        )
      }
    </Box>
